...
| P1-3 | Obsidian V1 integration entirely absent | 5 | **PARTIAL (2A)** — Notes Hub route/screen exists and is truthful ("Obsidian not connected"; no scanned files / indexed Markdown / note bodies). Filesystem read + markdown index remain Batch 5. |
...
| P1-18 | Per-entity create/edit gaps (Course/attempt, Topic/Source, Project/Skill/Milestone, Budget/Savings, Book, Block, Capacity) | 2 | **PARTIAL (2A)** — Academic Course/Topic/Assessment/Attempt + Knowledge Topic/Source/Evidence all now have create/edit/delete UI + tests. Project/Skill/Milestone, Budget/Savings, Book, Block, Capacity remain Batch 2B. |
