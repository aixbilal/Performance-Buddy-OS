# PBOS — Development Overview

**Archive:** V1 Screen Decision Archive  
**Design Part:** Day 06  
**Screen / State:** Development Overview  
**Status:** PRODUCT/UI DECIDED — V1  
**Reference:** `PBOS-Development-Overview-v1-REFERENCE.png`
...
## Purpose
Development Overview gives a high-level view of active projects, learning paths, skill growth and the next development work.

## Locked Decisions
- Keep Project Progress, Skill Progress, Knowledge and Actions separate.
- Show active projects and current milestones without equating “project built” with “skill mastered.”
- Surface current learning path/skills and evidence.
- Highlight blockers/decisions/dependencies accurately.
- Provide meaningful next development Action.
- AI can recommend priorities/gaps but not silently mark skills demonstrated.
- Use shared Actions and shared Knowledge where relevant.

## Final-Audit Checks
- Project and Skill metrics are not conflated.
- Active project links to Project Detail.
- Skills link to canonical Skill Detail.
