# PBOS — Development Learning Path

**Archive:** V1 Screen Decision Archive  
**Design Part:** Day 06  
**Screen / State:** Development Learning Path  
**Status:** PRODUCT/UI DECIDED — V1  
**Reference:** `PBOS-Development-Learning-Path-v1-REFERENCE.png`
...
## Purpose
Learning Path structures skill progression over time, including prerequisites and a primary progression sequence.

## Locked Decisions
- A primary path such as Full-Stack + AI can organize progression.
- Skills have states: Not Started → Learning → Practicing → Demonstrated → Needs Refresh.
- Prerequisites and sequence are visible enough to guide what comes next.
- Learning Path progress is not merely hours watched or course completion.
- Path sessions/actions can reuse shared session/action models.
- Links to Knowledge topics, projects and evidence are important.
- AI may suggest sequence changes but user approval and prerequisite logic remain authoritative.

## Final-Audit Checks
- Path state derives from actual skills/evidence.
- Project work can feed the path without auto-demonstrating every skill.
