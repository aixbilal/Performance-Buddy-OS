# PBOS — Development Skill Detail

**Archive:** V1 Screen Decision Archive  
**Design Part:** Day 06  
**Screen / State:** Development Skill Detail  
**Status:** PRODUCT/UI DECIDED — V1  
**Reference:** `PBOS-Development-Skill-Detail-v1-REFERENCE.png`
...
## Purpose
Skill Detail determines what the user actually knows and can do for one technical skill.

## Locked 3-Axis Model
- **Knowledge** — can explain.
- **Practice** — has actually used it.
...
## Technical Testing
Can include conceptual explanation, code reading, debugging, implementation, architecture or mini-project evidence; not only MCQ.

## Final-Audit Checks
- AI-built work is not automatically marked independent capability.
- Evidence remains inspectable.
- Skill state can become Needs Refresh.
