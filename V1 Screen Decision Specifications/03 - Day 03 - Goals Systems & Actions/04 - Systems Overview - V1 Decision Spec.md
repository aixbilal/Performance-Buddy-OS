# PBOS — Systems Overview

**Archive:** V1 Screen Decision Archive  
**Design Part:** Day 03  
**Screen / State:** Systems Overview  
**Status:** PRODUCT/UI DECIDED — V1  
**Reference:** `PBOS-Systems-Overview-v1-REFERENCE.png`
...
## Purpose
Systems Overview shows the repeatable processes that turn Goals or desired behavior into consistent execution.

## Locked Decisions
- System is a repeatable process, not a Goal and not an individual Action.
- Systems may exist with or without a formal Goal when that is appropriate.
- Each System can expose cadence, current health/compliance, next action, evidence and linked Goal(s).
- Health/consistency should not rely on fragile streak pressure.
- Overview should make weak/drifting Systems visible without gamified punishment.
- AI may recommend adjustments, but cannot silently rewrite cadence/rules.
- Systems across domains should share the same conceptual engine while allowing domain-specific evidence.

## Final-Audit Checks
- System health is evidence-based.
- System cards open canonical System Detail.
- No separate Action implementation exists inside Systems.
