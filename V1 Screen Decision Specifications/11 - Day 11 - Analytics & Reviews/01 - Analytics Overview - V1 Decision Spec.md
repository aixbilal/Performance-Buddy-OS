# PBOS — Analytics Overview

**Archive:** V1 Screen Decision Archive  
**Design Part:** Day 11  
**Screen / State:** Analytics Overview  
**Status:** PRODUCT/UI DECIDED — V1  
**Reference:** `PBOS-Analytics-Overview-v1-REFERENCE.png (DECIDED; PRIMARY REFERENCE NOT YET GENERATED)`
...
### Day 11 Shared Context
- Analytics & Reviews must not introduce a universal Performance Score.
...
- Missing data lowers the confidence/strength of an insight.
- Important insights should expose **Why? / Evidence**.
- Weekly Review is tactical; Monthly Review is strategic.
- The generated references are decision-support views, not permission for rainbow charts or decorative metrics.

## Purpose
Analytics Overview is the cross-domain evidence/trajectory surface: show meaningful patterns without collapsing human performance into one score.

## Locked Decisions
- **No universal Performance Score.**
- Activity, outcome and mastery remain separate dimensions.
- Cross-domain cards/charts keep their own units; do not normalize unrelated metrics into a fake common scale.
- Surface useful trends, changes and areas needing attention.
- Missing data must be explicit and lower insight strength.
- Correlations/associations are described carefully and never presented as proven causation.
- Important insights expose a **Why? / Evidence** path.
- Overview routes into Weekly Review, Monthly Review and Patterns/Insights.
- This screen was fully decided/spec'd but the primary image was not generated before the design track moved on. It is the one known missing primary reference in the 66-screen inventory.

## Final-Audit Checks
- Live implementation is reviewed especially carefully because no primary generated reference exists.
- Charts use restrained PBOS visual language.
- No synthetic global score.
