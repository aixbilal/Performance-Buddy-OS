# PBOS — Academics Overview

**Archive:** V1 Screen Decision Archive  
**Design Part:** Day 04  
**Screen / State:** Academics Overview  
**Status:** PRODUCT/UI DECIDED — V1  
**Reference:** `PBOS-Academics-Overview-v1-REFERENCE.png`
...
## Purpose
Academics Overview answers: **What is the state of my semester, which courses need attention, what is next, and where are the academic risks?**

## Locked Sections
- Semester header/context.
- Course cards as primary content.
- Risks / attention areas.
- Upcoming academic timeline.
- Syllabus coverage.
- Grade trajectory.
- AI academic brief.
- Quick Academic Capture.
- Recent academic activity.

## Rules
- Overview is not where actual study happens; it routes into Course Detail / Study / Focus.
- Course state should reflect professor coverage, personal coverage and mastery distinctly when relevant.
- Course list can represent current/completed/repeated/failed states without hiding history.
- Credit hours and prerequisites are real academic data, not decorative tags.
- Risks should be explainable from evidence/deadlines/marks rather than invented urgency.
- Quick Academic Capture must use shared capture architecture once Day 16 exists.

## Final-Audit Checks
- Semester/course hierarchy is clear.
- Risks and next actions are traceable.
- Overview does not duplicate Course Detail.
