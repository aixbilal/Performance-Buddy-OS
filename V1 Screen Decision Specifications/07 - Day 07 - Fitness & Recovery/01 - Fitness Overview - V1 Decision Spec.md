# PBOS — Fitness Overview

**Archive:** V1 Screen Decision Archive  
**Design Part:** Day 07  
**Screen / State:** Fitness Overview  
**Status:** PRODUCT/UI DECIDED — V1  
**Reference:** `PBOS-Fitness-Overview-v1-REFERENCE.png`
...
## Purpose
Fitness Overview answers: **What should I do physically today, how is fitness progressing, and should I push, maintain or recover?**

## Core Loop
**Goal → Plan → Session → Evidence → Adaptation**

## Locked Decisions
- Show today's planned/recommended physical work, current plan context, recent performance and recovery/readiness context.
- Keep Goal, Training Plan, Session and Evidence separate.
- Recovery influences recommendation but is not medical diagnosis.
- AI may recommend adaptation; user chooses.
- Avoid streak-heavy gamification and “punishment” framing.
- Evidence includes reps/duration/distance/load/completion.
- Nutrition/routines may influence context but remain separate domains.

## Final-Audit Checks
- Today's workout links to canonical plan/session.
- Recovery does not silently overwrite base plan.
