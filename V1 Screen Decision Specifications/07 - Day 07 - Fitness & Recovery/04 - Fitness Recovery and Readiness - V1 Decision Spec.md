# PBOS — Fitness Recovery & Readiness

**Archive:** V1 Screen Decision Archive  
**Design Part:** Day 07  
**Screen / State:** Fitness Recovery & Readiness  
**Status:** PRODUCT/UI DECIDED — V1  
**Reference:** `PBOS-Fitness-Recovery-Readiness-v1-REFERENCE.png`
...
## Purpose
Recovery & Readiness provides non-medical context for deciding whether to push, maintain or recover.

## Locked Decisions
- Inputs can include available recovery signals, recent workload and user-reported state.
- Output is guidance/recommendation, not diagnosis.
- Missing data must be treated as unknown, not fabricated readiness.
- A recommendation can influence Today's Prescription while leaving Base Plan intact.
- User remains the decision-maker.
- Avoid overconfident scores if evidence is weak.
- Recovery context may explain why a planned session was adjusted.

## Final-Audit Checks
- No medical claims.
- No silent plan mutation.
- Missing evidence reduces certainty rather than becoming zero.
