# PBOS — Mastery Assessment

**Archive:** V1 Screen Decision Archive  
**Design Part:** Day 02  
**Screen / State:** Mastery Assessment  
**Status:** PRODUCT/UI DECIDED — V1  
**Reference:** `PBOS-Mastery-Assessment-v1-REVIEW.png`
...
## Purpose
Mastery Assessment tests whether the user can actually demonstrate understanding after learning or Focus work.

## Locked Decisions
- Assessment may be generated or assembled with AI assistance, but result evaluation/state remains deterministic/rubric-driven where applicable.
- Assessments can include more than simple MCQs depending on topic: recall, explanation, problem solving, code reading, debugging or other evidence-appropriate formats.
- The screen must identify the linked Course/Topic and assessment purpose.
- Starting an assessment does not itself change mastery.
- Questions should assess the target concept rather than arbitrary trivia.
- The user can complete and submit; PBOS records evidence and routes to Mastery Results.
- Missing AI must not make all assessment capability disappear if deterministic/manual assessment content is available.
- Generated reference used stronger semantic/gold coloring than desired; treat it as structural only.
...
These are meaningful evidence states, not decorative labels.

## Final-Audit Checks
- Assessment links to canonical topic.
- Evidence is stored separately from raw study time.
- AI is not the authority for final academic math/state validation.
