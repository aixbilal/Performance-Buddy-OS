...
**Design Part:** Day 02  
**Screen / State:** Normal Study  
**Status:** PRODUCT/UI DECIDED — V1  
**Reference:** `PBOS-Normal-Study-v1-PRIMARY.png`
...
## Purpose
Normal Study is the default everyday academic learning workflow. It supports real university conditions where professor material may be complete, delayed, partial or missing.

## Core Flow
**Professor/peer/AI material → Learn → Create notes → Save/link Obsidian → Test → Update mastery/progress**

## Locked Decisions
- The screen identifies the Course and Topic being studied.
- Material provenance must remain visible: professor material, peer material, own material, AI-assisted material and past papers are not treated as the same source.
- The learner can study from available material, create or link notes, and move into a mastery check without leaving the academic model.
- Normal Study is not forced into a timer. Focus is optional and used when deliberate uninterrupted execution is valuable.
- Notes created here should route to the authoritative note/Obsidian workflow rather than a duplicate editor.
- Topic progress must not be represented by one vague percentage that conflates professor coverage, personal study coverage and mastery.
- If professor material is unavailable, the system may support AI guidance while making the source clear.
- Normal Study feeds evidence and topic state; it does not mark mastery merely because material was opened or time was spent.

## Expected Actions
- Open/select learning material.
- Learn/read/practice.
- Create/link notes.
- Start a mastery assessment.
- Optionally start Focus for targeted execution.
- Mark/record personal study coverage where supported.

## Final-Audit Checks
- Verify material provenance is preserved.
- Verify completion/time does not automatically create mastery.
- Verify Obsidian note handling uses the shared Knowledge/Notes architecture.
- Verify Focus remains a separate capability.
