# PBOS — Schedule Conflict & Capacity

**Archive:** V1 Screen Decision Archive  
**Design Part:** Day 13  
**Screen / State:** Schedule Conflict & Capacity  
**Status:** PRODUCT/UI DECIDED — V1  
**Reference:** `PBOS-Schedule-Conflict-Capacity-v1-REFERENCE.png`
...
## Purpose
Conflict & Capacity explains when the requested plan cannot fit and why.

## Locked Decisions
- Distinguish hard conflicts, protected-time conflicts, capacity overload and preference conflicts.
- Empty time is not equivalent to available productive capacity.
- Show which constraints are causing the problem.
- Offer safe resolution paths: move flexible work, reduce/exclude optional work, change temporary constraints, or accept that not everything fits.
- Do not solve overload by silently cutting protected sleep.
- Daily and weekly limits remain visible/understandable.
- AI may explain options; deterministic scheduler validates them.

## Final-Audit Checks
- No impossible schedule is labeled successful.
- User can understand what must change.
