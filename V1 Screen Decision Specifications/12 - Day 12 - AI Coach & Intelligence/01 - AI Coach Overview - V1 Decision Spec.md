# PBOS — AI Coach Overview

**Archive:** V1 Screen Decision Archive  
**Design Part:** Day 12  
**Screen / State:** AI Coach Overview  
**Status:** PRODUCT/UI DECIDED — V1  
**Reference:** `PBOS-AI-Coach-Overview-v1-REFERENCE.png`
...
## Purpose
AI Coach Overview provides a concise, evidence-grounded intelligence layer over PBOS without becoming the system of record.

## Locked Decisions
- Present a Coach Brief, relevant current context, high-value recommendations and quick questions/actions.
- AI uses selected/minimized permitted PBOS context.
- Recommendation remains a recommendation until user approves a change.
- “Why these?”/evidence paths should be available for important advice.
- AI can help plan the day, review academics, surface attention areas and help decide.
- If AI is disabled/unconfigured/unavailable, local PBOS remains fully useful.
- Context availability is inspectable/manageable through permissions.

## Architecture
Structured PBOS data → deterministic rules → minimized permitted context → AI interpretation/proposal → user decision → validation → applied change.

## Final-Audit Checks
- Coach does not invent stored facts.
- Recommendation/action distinction is visible.
