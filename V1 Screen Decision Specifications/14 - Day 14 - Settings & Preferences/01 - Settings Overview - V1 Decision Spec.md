# PBOS — Settings Overview

**Archive:** V1 Screen Decision Archive  
**Design Part:** Day 14  
**Screen / State:** Settings Overview  
**Status:** PRODUCT/UI DECIDED — V1  
**Reference:** `PBOS-Settings-Overview-v1-REFERENCE.png`
...
## Purpose
Settings Overview shows current configuration/health and gets the user to the exact setting quickly.

## Locked Areas
- Settings navigation: General / Performance / Intelligence / Application (or equivalent final grouping).
- Current configuration.
- Operating Mode: Normal / Midterm / Final / Recovery with preview.
...
- Setup Attention.
- App information.
- Advanced/destructive area separated.
- Settings Search.
...
## Final-Audit Checks
- Temporary/mode overrides do not rewrite baseline.
- Destructive actions are isolated/confirmed.
