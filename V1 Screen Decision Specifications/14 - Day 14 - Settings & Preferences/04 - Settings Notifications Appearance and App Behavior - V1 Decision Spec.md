# PBOS — Settings Notifications Appearance & App Behavior

**Archive:** V1 Screen Decision Archive  
**Design Part:** Day 14  
**Screen / State:** Settings Notifications Appearance & App Behavior  
**Status:** PRODUCT/UI DECIDED — V1  
**Reference:** `PBOS-Settings-Notifications-Appearance-v1-REFERENCE.png`
...
## Purpose
Controls attention, presentation and desktop application behavior.

## Locked Decisions
- Notification master and categories/priority.
- Quiet hours.
- Focus suppression/queue behavior.
- Digest behavior.
- Appearance: PBOS Dark / System where supported.
- Density.
- Sidebar behavior.
- Motion / Reduced Motion.
- Restrained visual effects.
- Startup page/behavior.
- Completion behavior.
- Confirmations.
...
## Rules
- Protect attention; AI should produce fewer, higher-value notifications.
- Routine schedule ≠ notification configuration.
- High-impact actions confirm.
- Appearance remains within PBOS identity.
- Timers/sessions survive normal navigation/minimize.
- Reset interface preferences ≠ reset user data.

## Final-Audit Checks
- Reduced Motion is respected.
- Notification settings do not change semantic routine schedules.
