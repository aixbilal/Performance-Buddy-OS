# PBOS — Onboarding Personal Setup

**Archive:** V1 Screen Decision Archive  
**Design Part:** Day 15  
**Screen / State:** Onboarding Personal Setup  
**Status:** PRODUCT/UI DECIDED — V1  
**Reference:** `PBOS-Onboarding-Personal-Setup-v1-REFERENCE.png`
...
## Purpose
Collect the minimum personal baseline needed for PBOS to plan responsibly.

## Locked Layout
Approximately 60% form / 40% live baseline summary in the reference.
...
- Week start.
- Current phase.
- Sleep target/preferred/protect.
- Rough weekday/weekend capacity.
- Fixed commitments (optional).
- Priorities up to 3.
- Conditional quick seed for Academic/Development/Fitness.
- Planning style.
- Planning buffer ~10% working default.
- Reminder preference.
- Live baseline preview.

## Rules
- No AI provider configuration here.
- Do not force full domain setup.
- Distinguish Required / Recommended / Optional.
- `Save & Exit` persists onboarding state so setup can resume.
- Values become base configuration, not temporary mode overrides.

## Final-Audit Checks
- Interrupted setup resumes.
- Protected sleep/capacity feed Settings/Planner correctly.
