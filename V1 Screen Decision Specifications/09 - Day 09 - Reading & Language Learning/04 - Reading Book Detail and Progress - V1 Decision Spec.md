# PBOS — Reading Book Detail & Progress

**Archive:** V1 Screen Decision Archive  
**Design Part:** Day 09  
**Screen / State:** Reading Book Detail & Progress  
**Status:** PRODUCT/UI DECIDED — V1  
**Reference:** `PBOS-Reading-Book-Detail-Progress-v1-REFERENCE.png`
...
## Purpose
Book Detail tracks one book's actual reading progress, notes/context and next reading action.

## Locked Decisions
- Track meaningful progress such as pages/chapters/current position where the user records it.
- Time/pages read are activity, not proof of understanding.
- Notes/insights can link to Knowledge and Obsidian.
- Reading cadence may connect to a Routine; the book screen owns book progress, not routine compliance.
- Goal may define desired reading outcome but does not replace progress history.
- Avoid unnecessary book-rating/social features in V1.

## Final-Audit Checks
- Book progress is real and user-controlled.
- Knowledge evidence remains separate.
