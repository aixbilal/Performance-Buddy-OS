# PBOS — Language Learning Session

**Archive:** V1 Screen Decision Archive  
**Design Part:** Day 09  
**Screen / State:** Language Learning Session  
**Status:** PRODUCT/UI DECIDED — V1  
**Reference:** `PBOS-Language-Learning-Session-v1-REFERENCE.png`
...
## Purpose
Language Learning Session is the active practice surface for a language-learning unit.

## Locked Decisions
- Session identifies language/path/topic and intended practice.
- Can record completion/activity and useful evidence.
- Completion/time does not automatically mark language knowledge mastered.
- May connect to vocabulary/recall or Knowledge evidence.
- Session is distinct from generic Focus even if Focus can optionally be used for concentrated practice.
- Keep active practice simple and low-friction.

## Final-Audit Checks
- Session writes to the language path and relevant evidence.
- No duplicate Routine check-in or Focus engine.
