# PBOS — Knowledge Learning & Capture

**Archive:** V1 Screen Decision Archive  
**Design Part:** Day 05  
**Screen / State:** Knowledge Learning & Capture  
**Status:** PRODUCT/UI DECIDED — V1  
**Reference:** `PBOS-Knowledge-Learning-Capture-v1-REFERENCE.png`
...
## Purpose
This is the learning/capture workflow for non-course topics such as cars, technology, history or other general knowledge.

## Locked Decisions
- Source can be AI, web, video, book, file, notes or other legitimate source.
- Workflow can include outline, learning notes, save/link to Obsidian, quick recall, knowledge-state update and review scheduling.
- Normal Study, Knowledge Learning and Focus are distinct workflows while reusing shared primitives.
- Example use case: learning about a BMW M3 should create/update a Knowledge topic rather than pretending it is an Academic course.
- Saving information is not mastery; recall/evidence drives state.
- AI may help summarize/explain but source provenance should remain clear.
- Long-form note content remains in Obsidian.

## Final-Audit Checks
- Capture creates canonical Knowledge item/topic.
- Quick recall can feed evidence.
- No duplicate learning-session infrastructure is introduced unnecessarily.
