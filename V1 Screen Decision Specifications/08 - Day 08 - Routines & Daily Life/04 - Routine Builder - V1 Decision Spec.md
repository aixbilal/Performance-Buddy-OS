# PBOS — Routine Builder

**Archive:** V1 Screen Decision Archive  
**Design Part:** Day 08  
**Screen / State:** Routine Builder  
**Status:** PRODUCT/UI DECIDED — V1  
**Reference:** `PBOS-Routine-Builder-v1-REFERENCE.png`
...
## Purpose
Routine Builder creates or edits one repeated daily-life behavior.

## Locked Decisions
- Capture identity/purpose, cadence, timing/reminder needs and relevant check-in method without excessive fields.
- Routine can exist without a Goal.
- Builder should support prayers/hydration/skincare/morning-evening/nutrition-style routines without hardcoding one template.
- Reminder configuration should remain separate from the semantic cadence where needed.
- AI can suggest but cannot auto-create silently.
- Use existing Routine engine; no duplicate scheduler.

## Final-Audit Checks
- Created routine appears in Overview/Today/check-ins.
- User can create it without AI.
