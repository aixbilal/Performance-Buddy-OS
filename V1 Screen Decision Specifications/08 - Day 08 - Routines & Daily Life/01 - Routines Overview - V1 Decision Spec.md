# PBOS — Routines Overview

**Archive:** V1 Screen Decision Archive  
**Design Part:** Day 08  
**Screen / State:** Routines Overview  
**Status:** PRODUCT/UI DECIDED — V1  
**Reference:** `PBOS-Routines-Overview-v1-REFERENCE.png`
...
## Purpose
Routines Overview shows repeated personal systems and what needs attention today without turning PBOS into a streak game.

## Locked Decisions
- Include routines such as prayers, hydration, skincare, morning/evening routine, nutrition-related behaviors and similar repeated systems.
- Show current cadence/state and today's relevant check-ins.
- Routine ≠ Goal; routines may exist independently.
- Consistency/compliance should be visible without fragile streak pressure.
- Provide clear entry to Routine Detail and Daily Check-In.
- Avoid one universal lifestyle score.
- Today integration should surface due/relevant routines without overwhelming the daily page.

## Final-Audit Checks
- Routine state is based on real check-ins/evidence.
- No forced Goal creation.
