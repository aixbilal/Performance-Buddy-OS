...
**Design Part:** Day 08  
**Screen / State:** Routine Detail  
**Status:** PRODUCT/UI DECIDED — V1  
**Reference:** `PBOS-Routine-Detail-v1-REFERENCE.png`
...
## Purpose
Routine Detail explains one repeated behavior: its cadence, history/evidence, reminders and relationship to broader Systems/Goals.

## Locked Decisions
- Show routine purpose, cadence/schedule, recent check-ins and useful consistency pattern.
- Optional Goal/System links do not change Routine identity.
- Allow appropriate editing of schedule/reminders through shared settings/routine architecture.
- Evidence/history remains inspectable.
- Avoid over-engineered lifestyle analytics.
- AI may recommend adjustment but should not silently change cadence.

## Final-Audit Checks
- Routine and System semantics remain distinct.
- Reminder configuration is not confused with the routine schedule itself.
