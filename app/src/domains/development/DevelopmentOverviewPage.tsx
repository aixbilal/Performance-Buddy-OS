  ...
  return (
    <div className="space-y-6">
      <div className="flex items-start justify-between">
        <div>
          <h2 className="t-h2 text-text-primary">Development</h2>
        ...
        <div className="flex items-center gap-3">
          ...
          <Button variant="secondary" onClick={() => navigate("/development/skills/new")}>
            Add Skill
          </Button>
          <Button variant="primary" onClick={() => navigate("/development/projects/new")}>
            Add Project
          </Button>
        </div>
      </div>
